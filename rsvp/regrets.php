...
<table id="list" cellspacing="0">
	...
	<tr>
		<th>Date</th>
        <th>Name</th>
		<th><a href="?re_order=email">E-Mail</a></th>
		<th>Manage</th>
	</tr>
<?php
...
$query = "SELECT * FROM rsvp WHERE status='No'";
...
while ($i < $num) {
	...
	echo "<tr><td>$date3</td><td>$name</td><td>$email</td><td nowrap><a href=\"view.php?id=$id\">View</a></td></tr>";
	$i++;
}
