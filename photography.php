...
<title>Photographs of Albert Volkman and Kendall Duprees wedding</title>
		...
		<div id="wrapper">
			...
			<div id="left-column">
                ...
                <ul>
                    ...
                    <li class="highlight"><a href="photography.php">Photography</a></li>
			...
			<div id="middle-column">
                ...
                <div id="centerimage">	
                <img src="_img/photography.jpg" alt="" >
                
                </div>
       
                <div id="breadcrumb">
                <p><a href="index.php">Home</a> &#8250; Photography</p>
    
                </div>
        
                <div id="content">
                <h1>Photography</h1>
                <h2>All about the pictures</h2>
                <p>During this wedding process, we will be taking lots of pictures. Be sure to check back here before, during, and after our wedding to see all the great photos!</p>
                
                    <div class="hub-left">
                    <img src="_img/engagement.png" alt="Engagement" width="70" height="100" >
                    <h4><a href="photography-engagement.php">Engagement</a></h4>
                    <p>Our engagement photos.<br >
    
                    </div>

                    <div class="hub-right">
                    <img src="_img/wedding.png" alt="Wedding" width="70" height="100" >
                    <h4><a href="#">Wedding</a></h4>
                    <p>Our wedding photos.<br >
                    <span style="color:#FF0000;">Not yet posted</span></p>
                    ...
                    <div class="hub-left">
                    <img src="_img/honeymoon.png" alt="Honeymoon" width="70" height="100" >
                    <h4><a href="#">Honeymoon</a></h4>
                    <p>Our honeymoon photos.<br >
                    <span style="color:#FF0000;">Not yet posted</span></p>
