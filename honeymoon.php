...
<title>Albert Volkman and Kendall Duprees honeymoon</title>
		...
		<div id="wrapper">
			...
			<div id="left-column">
                ...
                <ul>
                    ...
                    <li><a href="registry.php">Registry</a></li><li><a href="contact.php">Contact &amp; RSVP</a></li>
                    <li><a href="photography.php">Photography</a></li>
                    <li class="highlight"><a href="honeymoon.php">Honeymoon</a></li>
                </ul>
			...
			<div id="middle-column">
                ...
                <div id="centerimage">	
                <img src="_img/jamaica.jpg" alt="" >
                
                </div>
   
                <div id="breadcrumb">
                <p><a href="index.php">Home</a> &#8250; Honeymoon</p>
                ...
                <p>We have chosen to go to Montego Bay, Jamaica for our honeymoon. We were referred by several people (thanks guys!) and really feel that our vacation package through Sandals is going to be wonderful.</p>
                <p>We can't wait to go and spend the first week of our entire lives together in such an exciting locale. And, of course, we'll be sure to share it all with you (check out the photography section!) when we get back.</p>
                <p>Thanks so much everyone for sharing in this awesome part Albert and Kendall's journey!</p>
