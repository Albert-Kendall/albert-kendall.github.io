...
<title>About College Park Presbyterian Church</title>
		...
		<div id="wrapper">
			...
			<div id="left-column">
                ...
                <ul>
                    ...
                    <li class="highlight"><a href="venue.php">The Venue</a></li>
			...
			<div id="middle-column">
				...
				<div id="centerimage">	
                <img src="_img/venue.jpg" alt="" title=""/>

                </div>
   
                <div id="breadcrumb">
                <p><a href="index.php">Home</a> &#8250; Venue</p>
                
                </div>
	
                <div id="content">
                <h1>The Venue</h1>
                <h2>Details about the location for the wedding</h2>
                <p>&nbsp;</p>
