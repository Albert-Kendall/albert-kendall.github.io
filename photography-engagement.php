...
<script type="text/javascript" src="_inc/scriptaculous.js?load=effects"></script>
<script type="text/javascript" src="_inc/lightbox.js"></script>
	...
	<div id="container">
		...
		<div id="wrapper">
			...
			<div id="middle-column">
                ...
                <div id="breadcrumb">
                <p><a href="index.php">Home</a> &#8250; <a href="photography.php">Photography</a> &#8250; Engagement</p>
				...
				$i=0;
				chdir( '_img/engagement/' );
				$rep=opendir('.');
				while (false != ($file = readdir($rep))){
					if ($file!="." && $file!=".." && !is_dir($file)){
						$templates[$i] = $file;
						echo "<a href=\"_img/engagement/$file\" rel=\"lightbox[engagement]\" class=\"lightboximage\"><img src=\"_img/engagement/_thumb/$file\" alt=\"Albert &amp; Kendall\"></a>";
						$i++;
					}
				}
				chdir( '../..' );
